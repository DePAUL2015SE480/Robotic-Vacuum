...
public class BreadthFirstPaths {
     ...
     */
    public BreadthFirstPaths(Graph G, Floor s) {
        marked = new boolean[G.totalCells()];
        distTo = new int[G.totalCells()];
        edgeTo = new int[G.totalCells()];
        bfs(G, s);
     ...
     */
    public BreadthFirstPaths(Graph G, Iterable<Edge> sources) {
        marked = new boolean[G.totalCells()];
        distTo = new int[G.totalCells()];
        edgeTo = new int[G.totalCells()];
        for (int v = 0; v < G.totalCells(); v++)
        bfs(G, sources);
    }
    ...
    private void bfs(Graph G, Iterable<Edge> sources) {
